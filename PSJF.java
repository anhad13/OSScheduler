...
public class PSJF
{
	public static void run(Queue<Process> inqueue, Scanner randomfile, boolean is_verbose)
	{
		...
		while(done < todo)
		{
			...
			Process pa=readyqueue.poll();
			if(current_process!=null && pa!=null && pa.arrival_time==clock &&(pa.remaining_cpu_time<current_process.remaining_cpu_time-(clock-current_process.last_started)))
			{
				//System.out.printf("----------");
				current_process.left_from_preempt=current_process.into_queue_time-clock;
